# Unbounded knapsack (literature secondary)
...
Catalog search query: `unbounded knapsack heuristic`.
...
Target heuristics (search hints only): Unbounded density greedy (not_mappable), Greedy by value (not_mappable).
