# Stochastic TSP (literature secondary)

Secondary literature variant, not a new registered EoH problem_id.

## 定义或方法步骤

Random distances or presence.

Catalog search query: `stochastic TSP heuristic`.
...
Target heuristics (search hints only): Expected-cost NN (not_mappable), Recourse 2-opt (not_mappable).
