# Bin packing with conflicts (literature secondary)
...
Catalog search query: `bin packing with conflicts heuristic`.
...
Target heuristics (search hints only): Conflict-aware FF (not_mappable), Graph coloring + packing (not_mappable).
