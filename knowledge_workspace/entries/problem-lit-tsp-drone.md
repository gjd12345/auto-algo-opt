# TSP with drone (literature secondary)
...
Catalog search query: `TSP with drone heuristic`.
...
Target heuristics (search hints only): Truck-drone NN (not_mappable), Drone launch local search (not_mappable).
