# Large-scale CVRP (literature secondary)
...
Catalog search query: `large scale VRP heuristic`.
...
Target heuristics (search hints only): Restricted NN (next_node_score), Ruin-and-recreate (not_mappable).
