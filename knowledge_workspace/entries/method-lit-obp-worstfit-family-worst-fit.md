...
- Take the next item in online order
- Among open bins that can hold it, choose the largest residual
- Open a new bin if none fit

Why selected: Johnson et al. Worst Fit: among feasible bins prefer the largest residual.

## 适用条件、假设与限制

Subproblem: Worst-Fit online family — Prefer emptiest bin.

Adapter is return bins (emptiest residual). Official template is this rule.
...
- mappable: possible
- not_the_original: Adapter is return bins (emptiest residual). Official template is this rule.
