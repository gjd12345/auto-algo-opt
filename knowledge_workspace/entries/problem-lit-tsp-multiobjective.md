# Multi-objective TSP (literature secondary)
...
Catalog search query: `multiobjective TSP heuristic`.
...
Target heuristics (search hints only): Weighted-sum NN (not_mappable), Pareto 2-opt (not_mappable).
