# Online knapsack (literature secondary)
...
Catalog search query: `online knapsack heuristic`.
...
Target heuristics (search hints only): Threshold online knapsack (not_mappable), Secretary-style take (not_mappable).
