# Multifit / batch packing context

Literature method card from an OpenAlex abstract plus grok-4.5 screen. This is not a main-tree implementation.

## 定义或方法步骤

- Apply Multifit / batch packing context as introduced in Preserving Proximity in Arrays (1975).
- Items arrive in batches.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for bp_batch.

## 适用条件、假设与限制

Subproblem: Batch packing — Items arrive in batches.

DOI-directed fill. Adapter is not the original algorithm unless the abstract already matches the entrypoint.

## 来源及支持的具体结论

Preserving Proximity in Arrays (1975). DOI 10.1137/0204038. read_depth=abstract. Do not copy publisher PDF into the release.
