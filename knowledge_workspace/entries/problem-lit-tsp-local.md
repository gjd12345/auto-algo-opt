# Local-search TSP (literature secondary)
...
Catalog search query: `2-opt 3-opt or-opt TSP local search`.
...
Target heuristics (search hints only): 2-opt (move_selector), Or-opt (not_mappable).
