# Multi-objective knapsack (literature secondary)
...
Catalog search query: `multiobjective knapsack heuristic`.
...
Target heuristics (search hints only): Weighted-sum greedy (not_mappable), Pareto greedy (not_mappable).
