# Group knapsack (literature secondary)
...
Catalog search query: `group knapsack heuristic`.
...
Target heuristics (search hints only): Group greedy (not_mappable), Group local search (not_mappable).
