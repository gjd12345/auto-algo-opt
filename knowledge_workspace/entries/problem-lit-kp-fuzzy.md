# Fuzzy knapsack (literature secondary)
...
Catalog search query: `fuzzy knapsack heuristic`.
...
Target heuristics (search hints only): Fuzzy density greedy (not_mappable), Defuzzified greedy (not_mappable).
