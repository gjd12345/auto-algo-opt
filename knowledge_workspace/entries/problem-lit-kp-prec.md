# Precedence knapsack (literature secondary)
...
Catalog search query: `precedence constrained knapsack heuristic`.
...
Target heuristics (search hints only): Precedence greedy (not_mappable), Topo-order greedy (not_mappable).
