# Colored bin packing (literature secondary)
...
Catalog search query: `colored bin packing heuristic`.
...
Target heuristics (search hints only): Color-aware FF (not_mappable), Colored Best Fit (not_mappable).
