# Stochastic knapsack (literature secondary)
...
Catalog search query: `stochastic knapsack heuristic`.
...
Target heuristics (search hints only): Expected-density greedy (not_mappable), Recourse knapsack (not_mappable).
