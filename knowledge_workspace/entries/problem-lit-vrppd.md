# VRP with pickups and deliveries (literature secondary)
...
Catalog search query: `VRP pickup delivery heuristic`.
...
Target heuristics (search hints only): Paired insertion (not_mappable), PDP VND (not_mappable).
