...
- Apply Precedence greedy as introduced in Precedence Constrained Routing and Helicopter Scheduling: Heuristic Design (1992).
- Item precedences.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for kp_prec.

## 适用条件、假设与限制

Subproblem: Precedence knapsack — Item precedences.

DOI-directed fill. Adapter is not the original algorithm unless the abstract already matches the entrypoint.

## 来源及支持的具体结论

Precedence Constrained Routing and Helicopter Scheduling: Heuristic Design (1992). DOI 10.1287/inte.22.3.100. read_depth=abstract. Do not copy publisher PDF into the release.
