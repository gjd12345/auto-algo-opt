# Greedy knapsack variants

Literature method card from an OpenAlex abstract plus grok-4.5 screen. This is not a main-tree implementation.

## 定义或方法步骤

- Apply Greedy knapsack variants as introduced in The Status of Nonlinear Programming Software (1979).
- Take items in file order if they fit.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for kp_order_greedy.

## 适用条件、假设与限制

Subproblem: Order-greedy 0-1 (matches main Go solver) — Take items in file order if they fit.

DOI-directed fill. Adapter is not the original algorithm unless the abstract already matches the entrypoint.

## 来源及支持的具体结论

The Status of Nonlinear Programming Software (1979). DOI 10.1287/opre.27.3.431. read_depth=abstract. Do not copy publisher PDF into the release.
