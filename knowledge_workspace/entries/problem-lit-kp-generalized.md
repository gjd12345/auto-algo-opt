# Generalized knapsack (literature secondary)
...
Catalog search query: `generalized knapsack heuristic`.
...
Target heuristics (search hints only): GAP greedy (not_mappable), GAP regret (not_mappable).
