# 0-1 knapsack (literature secondary)
...
Catalog search query: `0-1 knapsack greedy heuristic`.
...
Target heuristics (search hints only): Density greedy (not_mappable), Greedy + swap (not_mappable).
