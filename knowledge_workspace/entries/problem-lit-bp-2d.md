# 2D bin packing (literature secondary)
...
Catalog search query: `two dimensional bin packing heuristic`.
...
Target heuristics (search hints only): Maxrects (not_mappable), Guillotine 2D (not_mappable).
