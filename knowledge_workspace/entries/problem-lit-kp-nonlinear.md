# Nonlinear knapsack (literature secondary)
...
Catalog search query: `nonlinear knapsack heuristic`.
...
Target heuristics (search hints only): Nonlinear greedy (not_mappable), Linearisation heuristic (not_mappable).
