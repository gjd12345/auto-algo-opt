# Multiple knapsack greedy

Literature method card from an OpenAlex abstract plus grok-4.5 screen. This is not a main-tree implementation.

## 定义或方法步骤

- Apply Multiple knapsack greedy as introduced in The Status of Nonlinear Programming Software (1979).
- Several knapsacks.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for kp_multiple.

## 适用条件、假设与限制

Subproblem: Multiple knapsack — Several knapsacks.
