# Angular-metric TSP (literature secondary)
...
Catalog search query: `angular metric TSP heuristic`.
...
Target heuristics (search hints only): Angle-aware NN (next_node_score), Or-opt for turning cost (move_selector).
