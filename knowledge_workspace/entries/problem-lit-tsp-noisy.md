# Noisy / black-box distances (literature secondary)
...
Catalog search query: `noisy TSP heuristic`.
...
Target heuristics (search hints only): Robust NN (not_mappable), Repeated 2-opt (not_mappable).
