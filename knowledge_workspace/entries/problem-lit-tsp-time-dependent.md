# Time-dependent TSP (literature secondary)
...
Catalog search query: `time dependent TSP heuristic`.
...
Target heuristics (search hints only): Time-dependent NN (not_mappable), TD 2-opt (not_mappable).
