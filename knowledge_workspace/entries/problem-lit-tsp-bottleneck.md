# Bottleneck TSP (literature secondary)
...
Catalog search query: `bottleneck traveling salesman heuristic`.
...
Target heuristics (search hints only): Bottleneck NN (next_node_score), Threshold binary search + MST (not_mappable).
