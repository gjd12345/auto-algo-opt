# Compartmentalized knapsack (literature secondary)
...
Catalog search query: `compartmentalized knapsack heuristic`.
...
Target heuristics (search hints only): Compartment greedy (not_mappable), Compartment local search (not_mappable).
