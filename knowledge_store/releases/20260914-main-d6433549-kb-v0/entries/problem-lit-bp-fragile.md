# Fragile objects (literature secondary)
...
Catalog search query: `fragile objects bin packing heuristic`.
...
Target heuristics (search hints only): Fragile FFD (not_mappable), Load-limit packing (not_mappable).
