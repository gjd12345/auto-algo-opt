# Min-max multiple TSP

Literature method card from an OpenAlex abstract plus grok-4.5 screen. This is not a main-tree implementation.

## 定义或方法步骤

- Apply Min-max multiple TSP as introduced in Complexity results for well‐covered graphs (1992).
- Minimise the longest salesman tour.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for tsp_minmax.

## 适用条件、假设与限制

Subproblem: Min-max mTSP — Minimise the longest salesman tour.

DOI-directed fill. Adapter is not the original algorithm unless the abstract already matches the entrypoint.

## 来源及支持的具体结论

Complexity results for well‐covered graphs (1992). DOI 10.1002/net.3230220304. read_depth=abstract. Do not copy publisher PDF into the release.
