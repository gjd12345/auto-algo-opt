# Open VRP (literature secondary)

Secondary literature variant, not a new registered EoH problem_id.

## 定义或方法步骤

Routes need not return.

Catalog search query: `open vehicle routing heuristic`.
...
Target heuristics (search hints only): Open NN (next_node_score), Open savings (next_node_score).
