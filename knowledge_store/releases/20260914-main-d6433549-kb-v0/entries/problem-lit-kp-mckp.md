# Multiple-choice knapsack (literature secondary)
...
Catalog search query: `multiple choice knapsack heuristic`.
...
Target heuristics (search hints only): MCKP greedy (not_mappable), Class-wise DP heuristic (not_mappable).
