# Integer knapsack (literature secondary)
...
Catalog search query: `integer knapsack heuristic`.
...
Target heuristics (search hints only): Integer density greedy (not_mappable), Rounding heuristic (not_mappable).
