# Heterogeneous fleet VRP (literature secondary)
...
Catalog search query: `heterogeneous fleet VRP heuristic`.
...
Target heuristics (search hints only): Type-aware savings (not_mappable), Fleet mix local search (not_mappable).
