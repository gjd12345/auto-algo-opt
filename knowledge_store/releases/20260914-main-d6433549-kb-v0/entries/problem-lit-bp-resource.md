# Resource-constrained packing (literature secondary)
...
Catalog search query: `resource constrained packing heuristic`.
...
Target heuristics (search hints only): Multi-resource BF (not_mappable), Resource FFD (not_mappable).
