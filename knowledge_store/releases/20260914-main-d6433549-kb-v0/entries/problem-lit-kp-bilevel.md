# Bilevel knapsack (literature secondary)
...
Catalog search query: `bilevel knapsack heuristic`.
...
Target heuristics (search hints only): Leader greedy (not_mappable), Reaction heuristic (not_mappable).
