# Knapsack with setups (literature secondary)
...
Catalog search query: `knapsack with setups heuristic`.
...
Target heuristics (search hints only): Setup-aware greedy (not_mappable), Class open/close local search (not_mappable).
