# Circular knapsack (literature secondary)
...
Catalog search query: `circular knapsack heuristic`.
...
Target heuristics (search hints only): Circular greedy (not_mappable), Break-circle greedy (not_mappable).
