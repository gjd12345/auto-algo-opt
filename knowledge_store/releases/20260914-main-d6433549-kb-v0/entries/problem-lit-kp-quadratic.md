# Quadratic knapsack (literature secondary)
...
Catalog search query: `quadratic knapsack heuristic`.
...
Target heuristics (search hints only): QKP greedy (not_mappable), QKP local search (not_mappable).
