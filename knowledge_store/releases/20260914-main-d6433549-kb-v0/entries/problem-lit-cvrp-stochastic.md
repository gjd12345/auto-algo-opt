# Stochastic-demand VRP (literature secondary)
...
Catalog search query: `stochastic demand VRP heuristic`.
...
Target heuristics (search hints only): Expected-demand NN (not_mappable), Recourse restocking (not_mappable).
