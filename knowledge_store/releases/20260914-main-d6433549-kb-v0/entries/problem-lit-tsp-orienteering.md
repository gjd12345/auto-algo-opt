# Orienteering / selective TSP (literature secondary)
...
Catalog search query: `orienteering problem heuristic`.
...
Target heuristics (search hints only): Prize/distance greedy (not_mappable), S-algorithm orienteering (not_mappable).
