# Distance-constrained VRP (literature secondary)
...
Catalog search query: `distance constrained VRP heuristic`.
...
Target heuristics (search hints only): Length-feasible NN (next_node_score), DCVRP savings (next_node_score).
