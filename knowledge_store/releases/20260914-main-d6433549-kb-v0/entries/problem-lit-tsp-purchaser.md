# Traveling purchaser (literature secondary)
...
Catalog search query: `traveling purchaser problem heuristic`.
...
Target heuristics (search hints only): TPP savings (not_mappable), Market insertion (not_mappable).
