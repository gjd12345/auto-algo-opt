# Bounded knapsack (literature secondary)
...
Catalog search query: `bounded knapsack heuristic`.
...
Target heuristics (search hints only): Bounded density greedy (not_mappable), Core algorithm heuristic (not_mappable).
