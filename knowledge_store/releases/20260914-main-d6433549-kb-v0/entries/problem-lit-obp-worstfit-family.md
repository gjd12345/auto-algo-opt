# Worst-Fit online family (literature secondary)
...
Catalog search query: `Worst Fit online bin packing`.
...
Target heuristics (search hints only): Worst Fit (bin_score), Almost Worst Fit (bin_score).
