...
Catalog search query: `pickup delivery time windows heuristic`.
...
Target heuristics (search hints only): PDPTW insertion (not_mappable), PDPTW ALNS (not_mappable).
