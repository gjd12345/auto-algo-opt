# Dial-a-ride (literature secondary)

Secondary literature variant, not a new registered EoH problem_id.

## 定义或方法步骤

Passenger transport with windows.

Catalog search query: `dial a ride problem heuristic`.
...
Target heuristics (search hints only): DARP insertion (not_mappable), DARP regret (not_mappable).
