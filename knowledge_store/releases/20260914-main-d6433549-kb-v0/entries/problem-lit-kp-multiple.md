# Multiple knapsack (literature secondary)
...
Catalog search query: `multiple knapsack heuristic`.
...
Target heuristics (search hints only): MKP greedy assign (not_mappable), MKP local search (not_mappable).
