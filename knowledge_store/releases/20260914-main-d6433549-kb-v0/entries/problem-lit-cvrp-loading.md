# VRP with loading (literature secondary)
...
Catalog search query: `VRP loading constraints heuristic`.
...
Target heuristics (search hints only): LIFO insertion (not_mappable), 3D packing + routing (not_mappable).
