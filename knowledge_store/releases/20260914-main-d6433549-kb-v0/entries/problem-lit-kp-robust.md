# Robust knapsack (literature secondary)
...
Catalog search query: `robust knapsack heuristic`.
...
Target heuristics (search hints only): Worst-case density greedy (not_mappable), Budgeted uncertainty greedy (not_mappable).
