# Discount knapsack (literature secondary)
...
Catalog search query: `discount knapsack heuristic`.
...
Target heuristics (search hints only): Discount greedy (not_mappable), Combo local search (not_mappable).
