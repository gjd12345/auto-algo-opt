# Multi-depot VRP (literature secondary)
...
Catalog search query: `multi depot VRP heuristic`.
...
Target heuristics (search hints only): Depot assignment + NN (not_mappable), MD savings (not_mappable).
