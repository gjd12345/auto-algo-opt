# Euclidean TSP (literature secondary)
...
Catalog search query: `Euclidean traveling salesman nearest neighbor heuristic`.
...
Target heuristics (search hints only): Nearest Neighbor (next_node_score), Farthest Insertion (not_mappable).
