# Covering salesman (literature secondary)
...
Catalog search query: `covering salesman problem heuristic`.
...
Target heuristics (search hints only): Covering greedy (not_mappable), Set-cover + TSP (not_mappable).
