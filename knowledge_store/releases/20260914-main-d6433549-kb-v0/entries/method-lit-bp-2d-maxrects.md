...
- Apply Maxrects as introduced in A Constructive Heuristic for Two-Dimensional Bin Packing (2013).
- Pack rectangles into bins.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for bp_2d.

## 适用条件、假设与限制

Subproblem: 2D bin packing — Pack rectangles into bins.

DOI-directed fill. Adapter is not the original algorithm unless the abstract already matches the entrypoint.

## 来源及支持的具体结论

A Constructive Heuristic for Two-Dimensional Bin Packing (2013). DOI 10.4028/www.scientific.net/amr.756-759.2705. read_depth=abstract. Do not copy publisher PDF into the release.
