# Multidimensional knapsack (literature secondary)
...
Catalog search query: `multidimensional knapsack heuristic`.
...
Target heuristics (search hints only): Surrogate density greedy (not_mappable), MDKP local search (not_mappable).
