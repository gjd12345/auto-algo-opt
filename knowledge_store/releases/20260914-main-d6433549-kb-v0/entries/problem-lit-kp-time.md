# Time-dependent knapsack (literature secondary)
...
Catalog search query: `time dependent knapsack heuristic`.
...
Target heuristics (search hints only): Time-slot greedy (not_mappable), TD knapsack local search (not_mappable).
