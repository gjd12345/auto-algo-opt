# Guillotine packing (literature secondary)
...
Catalog search query: `guillotine bin packing heuristic`.
...
Target heuristics (search hints only): Guillotine BF (not_mappable), Recursive guillotine (not_mappable).
