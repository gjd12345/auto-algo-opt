# DP / FPTAS (literature secondary)

Secondary literature variant, not a new registered EoH problem_id.

## 定义或方法步骤

Exact or approximate DP, not a constructive EoH elite.

Catalog search query: `knapsack FPTAS dynamic programming`.
...
Target heuristics (search hints only): Ibarra-Kim FPTAS (not_mappable), DP by capacity (not_mappable).
