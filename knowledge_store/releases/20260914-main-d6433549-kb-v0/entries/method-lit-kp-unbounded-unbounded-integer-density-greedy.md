# Unbounded / integer density greedy

Literature method card from an OpenAlex abstract plus grok-4.5 screen. This is not a main-tree implementation.

## 定义或方法步骤

- Apply Unbounded / integer density greedy as introduced in Discrete-Variable Extremum Problems (1957).
- Unlimited copies.
- Abstract-supported identity only; do not copy publisher PDF.

Why selected: DOI-seeded canonical paper for kp_unbounded.

## 适用条件、假设与限制

Subproblem: Unbounded knapsack — Unlimited copies.
