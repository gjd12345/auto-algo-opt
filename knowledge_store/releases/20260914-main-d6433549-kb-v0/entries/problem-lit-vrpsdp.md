# Simultaneous pickup and delivery (literature secondary)
...
Catalog search query: `VRP simultaneous pickup delivery heuristic`.
...
Target heuristics (search hints only): SDP NN (not_mappable), SDP local search (not_mappable).
