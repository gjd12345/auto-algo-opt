# Fleet size and mix (literature secondary)
...
Catalog search query: `fleet size mix VRP heuristic`.
...
Target heuristics (search hints only): Golden FSM constructive (not_mappable), FSM local search (not_mappable).
