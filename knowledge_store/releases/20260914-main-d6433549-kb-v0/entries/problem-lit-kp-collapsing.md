# Collapsing knapsack (literature secondary)
...
Catalog search query: `collapsing knapsack heuristic`.
...
Target heuristics (search hints only): Collapsing greedy (not_mappable), Collapsing local search (not_mappable).
