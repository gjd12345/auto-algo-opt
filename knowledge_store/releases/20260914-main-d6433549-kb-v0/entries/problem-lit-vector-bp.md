# Vector bin packing (literature secondary)
...
Catalog search query: `vector bin packing heuristic`.
...
Target heuristics (search hints only): Vector FFD (not_mappable), Norm-based Best Fit (not_mappable).
