# Prize-collecting VRP (literature secondary)
...
Catalog search query: `prize collecting VRP heuristic`.
...
Target heuristics (search hints only): Prize/distance greedy (not_mappable), Selective VRP local search (not_mappable).
