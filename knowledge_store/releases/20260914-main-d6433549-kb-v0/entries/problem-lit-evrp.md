# Electric VRP (literature secondary)
...
Catalog search query: `electric vehicle routing heuristic`.
...
Target heuristics (search hints only): Charge-feasible NN (not_mappable), EVRP insertion (not_mappable).
